const articles = [
  {
      ...
      title: 'The Federal tax codes',
      content: [`The Internal Revenue Code (IRC)—Title 26 of the U.S. Code—is the basis of federal tax law in the United States. The 11 subtitles of the Code cover the different types of federal taxes including income, estate, gift and excise taxes. These code sections are the ultimate authority on federal taxes and all your tax forms and instructions are based on it.
      ...
      content: [`Federal tax law is more than just the IRC. In fact, Congress allows the Department of Treasury to issue regulations that interpret each code section with longer explanations and examples. As far as federal tax law is concerned, these regulations have substantial authority and the IRS has no choice but to enforce the tax law in accordance with these regulations.
      ...
      content: [`Although not every state imposes an income tax, each one certainly assesses other types of taxes such as property, inheritance and sales taxes. These too are the creation of the state governments; separate and distinct from the federal laws. As a result, state governments have their own tax codes that serve the same purpose as the IRC does to the federal government.
